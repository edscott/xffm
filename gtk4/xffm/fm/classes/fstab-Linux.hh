...
//        p->start_monitor(treeModel, "/dev/disk/by-partuuid");
    ...
    addDisksItem(GtkTreeModel *treeModel){ 
        ...
        auto utf_name = Basic::utf_string(_("Disks"));
   ...
   static gchar *
    ...
    addNFSItem(GtkTreeModel *treeModel){
         GtkTreeIter iter;
        auto name = "xffm:nfs";
        auto utf_name = Basic::utf_string(_("NFS Network Volume"));
    ...
    addSSHItem(GtkTreeModel *treeModel){
        ...
        auto utf_name = Basic::utf_string(_("SFTP (via SSH)"));
    ...
    addEcryptFSItem(GtkTreeModel *treeModel){
        ...
        auto utf_name = Basic::utf_string(_("eCryptfs Volume"));
    ...
    addCIFSItem(GtkTreeModel *treeModel){
         GtkTreeIter iter;
        auto name = "xffm:cifs";
        auto utf_name = Basic::utf_string(_("CIFS Volume"));
