...
class RunButton {
    ...
    run_button_c(void *data, const gchar * exec_command, pid_t child, gboolean shell_wrap){
	view_v = data;
	in_shell = shell_wrap;
    ...
    const gchar *
    get_icon_id(void){ return (const gchar *)icon_id;}

    const gchar *
    get_command(void){ return (const gchar *)command;}

    const gchar *
    get_workdir(void){ return (const gchar *)workdir;}

    const gchar *
    get_tip(void){ return (const gchar *)tip;}

    gint
    get_pid(void){ return (gint)pid;}

    gint
    get_grandchild(void){ return (gint)grandchild;}

    void *
    get_view_v(void){ return view_v;}
    ...
    void
    run_button_setup (GtkWidget *data){
	view_c *view_p =(view_c *)view_v;
	button = data;
