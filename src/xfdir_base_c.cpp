...
xfdir_base_c::xfdir_base_c(const gchar *data, gtk_c *data_gtk_c){
    gtk_p = data_gtk_c;
    path = g_strdup(data);
...
xfdir_base_c::~xfdir_base_c(void){
    g_free(path);
...
const gchar *
xfdir_base_c::get_label(void){
    return get_path();
}

const gchar *
xfdir_base_c::get_path(void){return (const gchar *)path;}
...
void 
xfdir_base_c::reload(const gchar *data){
...
GList *
xfdir_base_c::read_items (gint *heartbeat) {
...
const gchar *
xfdir_base_c::get_stat_pixbuf(xd_t *xd_p, gboolean restat){
...
const gchar *
xfdir_base_c::get_type_pixbuf(xd_t *xd_p){
...
const gchar *
xfdir_base_c::get_xfdir_iconname(void){
    if (strcmp(path, g_get_home_dir())==0) {
	return "user-home";
    }
...
const gchar *
xfdir_base_c::get_home_iconname(const gchar *data){
...
GtkTreeModel *
xfdir_base_c::get_tree_model (void){return treemodel;}

GtkTreeModel *
xfdir_base_c::mk_tree_model (void)
{
...
gint 
xfdir_base_c::get_icon_size(const gchar *name){
    if (strcmp(name, "..")==0) return GTK_ICON_SIZE_DND;
    return GTK_ICON_SIZE_DIALOG;
}

gint 
xfdir_base_c::get_icon_highlight_size(const gchar *name){
    return GTK_ICON_SIZE_DIALOG;
}

gint
xfdir_base_c::get_dir_count(void){ return dir_count;}

void
xfdir_base_c::insert_list_into_model(GList *data, GtkListStore *list_store){
...
gchar *
xfdir_base_c::get_window_name (void) {
    gchar *iconname;
    if(!path) {
