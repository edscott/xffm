...
message(STATUS "Checking for zip.h...")
find_path(ZIP_H  NAMES zip.h )
if(NOT ZIP_H)
    set(ZIP_H "ZIP_H_NOTFOUND")
    message( STATUS "zip.h is not found" )
else()
    set(ZIP_H "HAVE_ZIP_H 1")
    message( STATUS  "zip.h was found." )
    set(LIBZIP_LIBRARIES "-lzip")
    set(LIBZIP_FOUND "1")
endif()
