...
public:
	...
	gtk_icon_view_set_selection_mode (iconView_, GTK_SELECTION_SINGLE);
        ...
        g_signal_connect (this->iconView_, "item-activated", 
                ICONVIEW_CALLBACK (View<Type>::item_activated), (void *)this);
        g_signal_connect (this->iconView_, "motion-notify-event", 
                ICONVIEW_CALLBACK (View<Type>::motion_notify_event), (void *)this);
...
public:
   ...
   /* void 
    ...
    clear_highlights(void){
        ...
        g_hash_table_foreach_remove (highlight_hash, View<double>::unhighlight, (void *)this);
    }
