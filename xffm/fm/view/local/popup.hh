...
public:
    ...
    resetMenuItems(void) {
        ...
        auto pixbuf = (GdkPixbuf *)g_object_get_data(G_OBJECT(localItemPopUp),  "pixbuf");
        TRACE("localpopup::object %p pixbuf=%p\n", localItemPopUp, pixbuf);
        ...
        Popup<Type>::changeTitle(localItemPopUp, markup, pixbuf);
